...
public final class CarAnchor extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_25_2_10(); }
  public static CarAnchor getRootAsCarAnchor(ByteBuffer _bb) { return getRootAsCarAnchor(_bb, new CarAnchor()); }
  public static CarAnchor getRootAsCarAnchor(ByteBuffer _bb, CarAnchor obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int endCarAnchor(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public CarAnchor get(int j) { return get(new CarAnchor(), j); }
    public CarAnchor get(CarAnchor obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  public CarAnchorT unpack() {
    CarAnchorT _o = new CarAnchorT();
    unpackTo(_o);
    return _o;
  }
  ...
  public static int pack(FlatBufferBuilder builder, CarAnchorT _o) {
    if (_o == null) return 0;
    startCarAnchor(builder);
    addIndex(builder, _o.getIndex());
    addLocal(builder, rlbot.flat.Vector3.pack(builder, _o.getLocal()));
    return endCarAnchor(builder);
  }
}
